...
Everything symbolic is SymPy's, unwrapped and re-exported. MathSlate adds a
small set of callables (:data:`NEW_API`) and one guarantee: the graph is right,
and you can always ask it what the plain Python was.
"""
